      ...
      {/* Hero Section with Advanced Animations */}
        ...
        >
          ...
          >
            ...
            >
              <Card className="glass-card p-8 bg-background/40 backdrop-blur-md border border-purple-500/30 lg:border-purple-500/10 hover:border-violet-500/50 transition-colors group">
              ...
              <Card className="glass-card p-8 bg-background/40 backdrop-blur-md border border-purple-500/30 lg:border-purple-500/10 hover:border-fuchsia-500/50 transition-colors group">
                <div className="flex items-center gap-3 mb-4 text-white font-bold text-2xl group-hover:text-metal-purple transition-colors">
              ...
              <Card className="glass-card p-8 bg-background/40 backdrop-blur-md border border-purple-500/30 lg:border-purple-500/10 hover:border-purple-500/50 transition-colors group">
                <div className="flex items-center gap-3 mb-4 text-white font-bold text-2xl group-hover:text-metal-purple transition-colors">
      ...
      >
        {values.map((value, index) => (
          <motion.div key={index} variants={staggerItem}>
            <Card className="glass-card p-10 h-full bg-background/50 border border-purple-500/30 lg:border-purple-500/10 hover:border-violet-500/40 hover:shadow-[0_0_30px_-5px_rgba(139,92,246,0.2)] transition-all duration-500 group">
    ...
    <section className="py-20 md:py-24 relative border-t border-border/40 bg-gradient-to-b from-secondary/5 to-background">
      ...
      <div className="container mx-auto px-6">
        ...
        <motion.div
          ...
          animate={isInView ? { opacity: 1, y: 0 } : {}}
          transition={{ duration: 0.5, ease: "easeOut" }}
          className="grid grid-cols-1 md:grid-cols-2 gap-0 max-w-5xl mx-auto rounded-[2.5rem] overflow-hidden border border-purple-500/30 lg:border-purple-500/10 shadow-2xl"
        >
          {/* Manual Work */}
      ...
      <div className="container mx-auto px-6">
        ...
        >
          {team.map((member, index) => (
            <motion.div key={index} variants={staggerItem}>
              <Card className="glass-card p-8 bg-background/50 border border-purple-500/30 lg:border-purple-500/10 group hover:border-violet-500/40 hover:shadow-[0_0_30px_-5px_rgba(139,92,246,0.2)] transition-all duration-500">
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-3xl mx-auto relative z-10">
          <Accordion type="single" collapsible className="w-full space-y-4">
            {faqs.map((faq, index) => (
              <AccordionItem key={index} value={`item-${index}`} className="glass-card bg-background/60 backdrop-blur-md border border-purple-500/30 lg:border-purple-500/10 px-6 rounded-xl data-[state=open]:border-violet-500/50 transition-all duration-300">
  ...
  return (
    <section className="relative py-24 md:py-32 overflow-hidden bg-black">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-16 bg-background/40 border border-purple-500/30 lg:border-purple-500/10 rounded-[2.5rem] p-10 lg:p-16 backdrop-blur-xl relative overflow-hidden shadow-2xl">
          ...
          <div className="lg:w-5/12 w-full max-w-md relative z-10 flex justify-center">
            <div className="w-[300px] h-[300px] md:w-[400px] md:h-[400px] rounded-[3rem] border border-purple-500/30 lg:border-purple-500/10 bg-black/50 backdrop-blur-sm flex items-center justify-center relative overflow-hidden shadow-2xl rotate-3 hover:rotate-0 transition-all duration-700">
