    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="pt-28 pb-16 relative overflow-hidden bg-gradient-to-b from-background to-secondary/10">
        ...
        <div className="container mx-auto px-6 relative">
          ...
          >
            <Badge className="mb-8 px-5 py-2 bg-secondary/80 border border-purple-500/30 lg:border-purple-500/10 text-foreground hover:bg-secondary backdrop-blur-md rounded-full text-sm font-medium">About Us</Badge>
      ...
      <section className="py-20 md:py-24 relative border-t border-border/40 bg-gradient-to-b from-secondary/5 to-background">
        <div className="container mx-auto px-6">
          ...
          >
            <Badge className="mb-8 px-5 py-2 bg-secondary/50 border border-purple-500/30 lg:border-purple-500/10 text-foreground text-sm">Our Solutions</Badge>
          ...
          >
            {solutions.map((solution, index) => (
              <motion.div key={index} variants={staggerItem}>
                <Card className="glass-card p-8 h-full bg-background/50 backdrop-blur-md border border-purple-500/30 lg:border-purple-500/10 hover:border-violet-500/40 hover:shadow-[0_0_30px_-5px_rgba(139,92,246,0.2)] transition-all duration-500 group flex flex-col">
      ...
      <section className="py-20 md:py-24 relative border-t border-border/40 bg-gradient-to-b from-background to-secondary/5">
        <div className="container mx-auto px-6">
          <motion.div
            ...
            className="text-center mb-16 flex flex-col items-center"
          >
            <Badge className="mb-8 px-5 py-2 bg-secondary/50 border border-purple-500/30 lg:border-purple-500/10 text-foreground text-sm">Our Process</Badge>
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 tracking-tight">
          ...
          >
            {process.map((item, index) => (
              <motion.div key={index} variants={staggerItem}>
                <Card className="glass-card p-8 h-full bg-background/50 backdrop-blur-md border border-purple-500/30 lg:border-purple-500/10 text-center relative overflow-hidden group hover:border-fuchsia-500/40 hover:shadow-[0_0_30px_-5px_rgba(217,70,239,0.2)] transition-all duration-500">
      ...
      <section className="py-20 md:py-24 relative border-t border-border/40 bg-gradient-to-b from-secondary/5 to-background">
        ...
        <div className="container mx-auto px-6">
          <motion.div
            ...
            className="text-center mb-16 flex flex-col items-center"
          >
            <Badge className="mb-8 px-5 py-2 bg-secondary/50 border border-purple-500/30 lg:border-purple-500/10 text-foreground text-sm">Key Benefits</Badge>
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 tracking-tight">
          ...
          >
            {benefits.map((benefit, index) => (
              <motion.div key={index} variants={staggerItem}>
                <Card className="glass-card p-8 bg-background/50 backdrop-blur-md border border-purple-500/30 lg:border-purple-500/10 flex gap-6 hover:shadow-xl hover:shadow-violet-500/10 hover:border-violet-500/40 transition-all duration-500 group">
      ...
      <section className="py-20 md:py-24 relative border-t border-border/40 bg-gradient-to-b from-background to-secondary/5">
        <div className="container mx-auto px-6">
          <motion.div
            ...
            className="text-center mb-16 flex flex-col items-center"
          >
            <Badge className="mb-8 px-5 py-2 bg-secondary/50 border border-purple-500/30 lg:border-purple-500/10 text-foreground text-sm">Testimonials</Badge>
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 tracking-tight">
          ...
          >
            {testimonials.map((testimonial, index) => (
              <motion.div key={index} variants={staggerItem}>
                <Card className="glass-card p-10 bg-background/50 backdrop-blur-md border border-purple-500/30 lg:border-purple-500/10 hover:border-violet-500/40 hover:shadow-[0_0_30px_-5px_rgba(139,92,246,0.1)] transition-all duration-500">
                  ...
                  <div className="flex items-center gap-4">
                    <div className="w-14 h-14 rounded-full bg-secondary flex items-center justify-center border border-purple-500/30 lg:border-purple-500/10">
