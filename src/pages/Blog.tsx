    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="pt-28 pb-16 relative overflow-hidden bg-gradient-to-b from-background to-secondary/10">
        <div className="container mx-auto px-6 relative">
          ...
          >
            <Badge className="mb-8 px-5 py-2 bg-secondary/80 border border-purple-500/30 lg:border-purple-500/10 text-foreground hover:bg-secondary backdrop-blur-md rounded-full text-sm font-medium">Blog</Badge>
          ...
          >
            {posts.map((post, index) => (
              <motion.div key={index} variants={staggerItem}>
                <Card className="glass-card p-4 bg-background/50 backdrop-blur-md border border-purple-500/30 lg:border-purple-500/10 cursor-pointer hover:border-violet-500/40 hover:shadow-[0_0_30px_-5px_rgba(139,92,246,0.2)] transition-all duration-300 group">
